# apl_360_parser.py
"""
Simple APL-like parser & REPL wiring core math primitives from the local 'modules' folder.
...
# Ensure both project root and modules directory are on sys.path
_script_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, _script_dir)
sys.path.insert(0, os.path.join(_script_dir, 'modules'))

# Now import math primitives directly
