# apl_360_parser.py
"""
Simple APL-like parser & REPL wiring core math primitives from the local 'modules' directory.
...
# Ensure the 'modules' directory is on sys.path so imports work
_script_dir = os.path.dirname(os.path.abspath(__file__))
_modules_dir = os.path.join(_script_dir, 'modules')
